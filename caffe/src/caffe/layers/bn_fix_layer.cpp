...
namespace caffe {
  ...
  void BNFixLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  template <typename Dtype>
  void BNFixLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  ...
  template <typename Dtype>
  void BNFixLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  ...
  template <typename Dtype>
  void BNFixLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
STUB_GPU(BNFixLayer);
  ...
  INSTANTIATE_CLASS(BNFixLayer);
  REGISTER_LAYER_CLASS(BNFix);
}  // namespace caffe
