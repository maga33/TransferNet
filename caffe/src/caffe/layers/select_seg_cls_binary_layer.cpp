...
SelectSegClsBinaryLayer<Dtype>::~SelectSegClsBinaryLayer<Dtype>() {
  this->StopInternalThread();
}

template <typename Dtype>
void SelectSegClsBinaryLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  CHECK(transform_param.has_mean_file() == false) << 
         "SelectSegClsBinaryLayer does not support mean file";
...
template <typename Dtype>
void SelectSegClsBinaryLayer<Dtype>::ShuffleImages() {
...
template <typename Dtype>
void SelectSegClsBinaryLayer<Dtype>::load_batch(Batch_seg<Dtype>* batch) {
...
INSTANTIATE_CLASS(SelectSegClsBinaryLayer);
REGISTER_LAYER_CLASS(SelectSegClsBinary);
}  // namespace caffe
