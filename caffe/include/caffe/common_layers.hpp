...
*/
template <typename Dtype>
class BNFixLayer : public Layer<Dtype> {
 /*
 notice:
 this code is based on the implementation of by following authors.
 ...
 */
 public:
  explicit BNFixLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
...
/**
 * @brief Compute scaling operations
 *        along multiple input Blobs.
 */
template <typename Dtype>
class ScaleLayer : public Layer<Dtype> {
 ...
 protected:
  void ConstructNetwork(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Forward_gpu(const vector<Blob<Dtype>*>& bottom,
  ...
  bool scale_by_param_;
  Dtype factor_;
  Blob<Dtype> Y_diff_X_;
 ...
 */
template <typename Dtype>
class VolumetricScaleLayer : public Layer<Dtype> {
 public:
  explicit VolumetricScaleLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "VolumetricScale"; }
 ...
 */
template <typename Dtype>
class FilterSumLayer : public Layer<Dtype> {
 public:
  explicit FilterSumLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "FilterSum"; }
  virtual inline int MinBottomBlobs() const { return 1; }
 ...
 */
template <typename Dtype>
class SumSqLayer : public Layer<Dtype> {
 public:
  explicit SumSqLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "SumSq"; }
  virtual inline int ExactNumBottomBlobs() const { return 1; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
...
class L1NormLayer : public Layer<Dtype> {
 public:
  explicit L1NormLayer(const LayerParameter& param)
      : Layer<Dtype>(param), factor_(0) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "L1Norm"; }
  virtual inline int MinBottomBlobs() const { return 1; }
 ...
 */
template <typename Dtype>
class ChannelSumLayer : public Layer<Dtype> {
 public:
  explicit ChannelSumLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "ChannelSum"; }
  virtual inline int MinBottomBlobs() const { return 1; }
